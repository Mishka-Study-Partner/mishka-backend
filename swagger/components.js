    ...
    ApiErrorEnvelope: {
      ...
      properties: {
        ...
        error: {
          type: "string",
          description:
            "Stable machine code: `VALIDATION_ERROR`, `AUTH_MISSING_TOKEN`, `AUTH_INVALID_TOKEN`, `AUTH_INVALID_CREDENTIALS`, `FORBIDDEN`, `NOT_FOUND`, `UNIQUE_VIOLATION`, `AI_SERVICE_ERROR`, `SERVICE_UNAVAILABLE`, `OAUTH_TOKEN_INVALID`, etc.",
        },
        details: {
          nullable: true,
